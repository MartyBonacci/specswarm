...
8. **BUDGET + COMMIT DISCIPLINE** — wall-clock budget, then verbatim: *"Commit PER COMPLETED ITEM. If you near the budget: COMMIT everything verified, write an honest partial report naming exactly what is un-run, and end — never die silent, never background-and-await."*
