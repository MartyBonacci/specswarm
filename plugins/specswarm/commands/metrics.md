...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "  /specswarm:metrics                  Dashboard summary"
echo "  /specswarm:metrics --recent 20      Show last 20 features"
echo "  /specswarm:metrics --feature 015    Feature 015 details"
echo "  /specswarm:metrics --sprint sprint-4   Sprint aggregates"
echo "  /specswarm:metrics --export         Export to CSV"
echo "  /specswarm:metrics --path /project  Analyze specific project"
echo ""
...
### Feature Details
```bash
/specswarm:metrics --feature 015
```
Complete metrics for Feature 015.

### Sprint Analysis
```bash
/specswarm:metrics --sprint sprint-4
```
...
/specswarm:metrics --export metrics-2025-11.csv
```

### Analyze Different Project
```bash
/specswarm:metrics --path /home/user/projects/myapp
```
