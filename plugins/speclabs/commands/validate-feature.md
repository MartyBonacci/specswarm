---
description: '⚠️ DEPRECATED - Use /specswarm:validate instead. This alias will be removed in v3.2.0'
---
...
```
Old command: /speclabs:validate-feature
New command: /specswarm:validate
```

**Note**: The command has been renamed from `validate-feature` to simply `validate` for simplicity.
...
echo ""
echo "Old: /speclabs:validate-feature"
echo "New: /specswarm:validate"
echo ""
echo "This alias will be removed in v3.2.0."
echo "Please update your workflows to use /specswarm:validate"
echo ""
