---
description: '⚠️ DEPRECATED - Use /specswarm:orchestrate instead. This alias will be removed in v3.2.0'
---
...
```
Old command: /speclabs:orchestrate
New command: /specswarm:orchestrate
```
...
echo ""
echo "Old: /speclabs:orchestrate"
echo "New: /specswarm:orchestrate"
echo ""
echo "This alias will be removed in v3.2.0."
echo "Please update your workflows to use /specswarm:orchestrate"
echo ""
...
```
/specswarm:orchestrate $ARGUMENTS
```
