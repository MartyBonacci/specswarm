...
2. Manually create `.specswarm/tech-stack.md`
3. Manually create `.specswarm/quality-standards.md`
...
# Output:
# ✅ Created .specswarm/constitution.md
# ✅ Created .specswarm/tech-stack.md
# ✅ Created .specswarm/quality-standards.md
#
# Next steps:
#   1. Review files in .specswarm/
...
**`.specswarm/tech-stack.md`** (NEW TEMPLATE):
```markdown
...
**`.specswarm/quality-standards.md`** (NEW TEMPLATE):
```yaml
# Quality Gates
...
#
# Executing rollback...
# ✅ Created revert commits
# ✅ Deleted spec.md, plan.md, tasks.md
# ✅ Branch feature/015-user-authentication deleted
# ✅ Switched to parent branch: develop
```
...
if [ "$CURRENT_BRANCH" = "main" ] || [ "$CURRENT_BRANCH" = "master" ]; then
  echo "❌ Cannot rollback main/master branch"
  exit 1
fi
...
if [ -n "$MERGED" ]; then
  echo "⚠️ WARNING: Branch already merged to $PARENT_BRANCH"
...
- ✅ Cannot rollback main/master
- ✅ Dry-run option
- ✅ Backup artifacts option
- ✅ Prevent rollback with uncommitted changes
...
#
# Executing release...
# ✅ Updated package.json (3.0.0 → 3.1.0)
# ✅ Updated CHANGELOG.md
# ✅ Created git commit "release: v3.1.0"
# ✅ Created git tag v3.1.0
# ✅ Pushed to origin/main
# ✅ Pushed tag v3.1.0
# ✅ Created GitHub release: https://github.com/user/repo/releases/tag/v3.1.0
#
# Release complete! 🎉
```
...
4. Version updates (3.1.0-alpha.1 → 3.1.0)
5. Create release PR
6. Merge to main
7. Tag v3.1.0
8. GitHub release
