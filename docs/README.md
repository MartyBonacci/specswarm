...
- **[Commands Reference](../COMMANDS.md)** - Complete documentation for all 34 commands (23 visible + 11 internal)
...
**Learning Commands:**
- Core commands → [Commands: Core Workflows](../COMMANDS.md#core-workflows)
- All 34 commands → [Commands Reference](../COMMANDS.md)
...
**Contents:**
- All commands organized by category (23 visible + 11 internal)
...
- **Commands Reference**: 700+ lines covering 34 commands (23 visible + 11 internal)
...
**SpecSwarm v7.19.3** — Documentation index (AUTO-MAGIC loop + conduct loop + 34 commands)
