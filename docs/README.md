...
- **[Commands Reference](../COMMANDS.md)** - Complete documentation for all 32 commands (21 visible + 11 internal)
...
**Contents:**
- All commands organized by category (21 visible + 11 internal)
...
- **Commands Reference**: 700+ lines covering 32 commands (21 visible + 11 internal)
...
**SpecSwarm v7.17.0** — Documentation index (AUTO-MAGIC loop + 32 commands)
