...
The deprecated `specswarm` plugin still appears in the marketplace as a stub through v7.x. It's kept in lockstep version-wise (currently v7.19.1) so users who installed the old name see a clear migration message. Slated for full removal in v8.0.0.
