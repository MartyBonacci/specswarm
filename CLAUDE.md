...
```
plugins/ss/
├── commands/        # 32 slash commands (21 visible + 11 internal/hidden)
...
│                    # v7.10.0: /ss:overnight    v7.16.0: /ss:bakeoff
│                    # v7.17.0: /ss:go (default entry point)
