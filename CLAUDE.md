...
```
plugins/ss/
├── commands/        # 34 slash commands (23 visible + 11 internal/hidden)
...
│                    # v7.18.0: /ss:conduct + /ss:mentor-init (four-minds extraction)
...
│   └── conduct/         # v7.18.0: mentor→builder dispatch (dispatch.sh) + mentor scaffold (scaffold.sh)
