...
pre_orchestration_hook: |
  ...
  echo "  3. Intelligent Bugfix: Auto-fix failures with /sw:bugfix"
...
- Execute SlashCommand: `/sw:implement`
...
IF ${failed} > 0:
  ...
  - Use the SlashCommand tool to execute: `/sw:bugfix`
...
3. Complete feature: Run `/sw:complete` to finalize with git workflow
