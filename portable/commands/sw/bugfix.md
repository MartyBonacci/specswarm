...
3. **If chain bugs detected:**
   ...
   b. **Offer actions:**
      ...
      1. Review fix and improve (analyze with /sw:analyze-quality)
   ...
   c. **Execute user choice:**
      - Option 1: Run `/sw:analyze-quality` for full analysis
...
3. View metrics: /sw:workflow-metrics ${FEATURE_NUM}
