...
### 🎯 Primary Recommendation: `/sw:[workflow]`
...
### Alternative 1: `/sw:[workflow2]`
**Confidence**: [Medium/Low]
**When to Use**: [Scenario where this would be better]

### Alternative 2: `/sw:[workflow3]`
**Confidence**: [Medium/Low]
**When to Use**: [Scenario where this would be better]
...
**Feature Development** → Use `/sw:*` workflows
...
2. **Run recommended workflow**: `/sw:[workflow]`
3. **If uncertain**, provide more context: `/sw:suggest "more details here"`

**Command to run**:
```
/sw:[recommended_workflow]
```
```
...
🎯 Recommended Workflow: /sw:[workflow]
Confidence: [High/Medium/Low]
...
🎯 Recommended Workflow: /sw:bugfix
Confidence: High
